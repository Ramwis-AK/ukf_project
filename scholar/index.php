...
class ScholarApp
{
    ...
    {
        // Load config and helpers here if needed
        $this->includeConfig();
        $this->includeHelpers();
    }
    ...
    {
        // Output the stylesheets that were previously echoed
        // We echo here inside <head> so we need to buffer or split properly.
        // So we'll output page header, then stylesheets, then rest of page.
